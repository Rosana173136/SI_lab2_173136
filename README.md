...
Во овој граф имаме 23 јазли и 29 ребра па затоа цикломатската комплексност е: (29-23)+2 = 8 исто така овој резултат можеме да го добиеме со броење на предикатни јазли(7) и се додава 1 па така што 7+1 = 8.
...
Може да се покаже со 6 тест примери во кои 5 се од Exceptions и еден кога програмата завршува
Фотогррафија:
